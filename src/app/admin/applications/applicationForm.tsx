      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            <FormField control={form.control} name="availableUntil" render={({ field }) => <FormItem className="flex flex-col"><FormLabel>Disponível até </FormLabel><DateTimePicker date={field.value} setDate={field.onChange} /><FormMessage /></FormItem>} />
